...
const getBorder = (props) => {
  if (props.isNew) return `1px solid ${props.colors.primaryGreen}`;
  if (props.isRemoved) return `1px solid ${props.colors.primaryRed}`;
  return `1px solid ${props.colors.secondaryMiddleBlue}`;
};
